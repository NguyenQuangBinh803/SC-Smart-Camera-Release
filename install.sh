...
pip3 install -y opencv-contrib-python
pip3 install -y opencv-python==3.4.6.27
pip3 install -y tensorflow==1.14.0
pip3 install -y scikit-image
pip3 install -y requests
pip3 install -y protobuf==3.6.0
pip3 install -y scikit-learn==0.22.2
pip3 install -y imutils
pip3 install -y cython
pip3 install -y face_recognition
pip3 install -y dlib
